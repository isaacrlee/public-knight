    ...
    request(url, function (error, response, body) {
        ...
        if (orgs.length !== 0) {
            ...
            if (orgs.length > 3) {
                ...
                responseJSON.response = "We found " + orgs.length + " organizations working to make an impact in your community. Here are three we think you might be interested in.";
            } else {
                randa.push(0);
